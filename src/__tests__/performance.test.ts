...
describe('getTSBState', () => {
  it('classifies TSB ranges correctly', () => {
    ...
    expect(getTSBState(10)).toBe('fresh')
    expect(getTSBState(5)).toBe('fresh')
    expect(getTSBState(0)).toBe('steady')
    expect(getTSBState(-10)).toBe('steady')
    expect(getTSBState(-15)).toBe('build')
    expect(getTSBState(-30)).toBe('build')
    expect(getTSBState(-31)).toBe('overreaching')
    expect(getTSBState(-50)).toBe('overreaching')
  })
})
...
describe('getACWRRisk', () => {
  it('classifies ACWR ranges correctly', () => {
    ...
    expect(getACWRRisk(0.8)).toBe('in_range')
    expect(getACWRRisk(1.0)).toBe('in_range')
    expect(getACWRRisk(1.3)).toBe('in_range')
    expect(getACWRRisk(1.31)).toBe('ramping')
    expect(getACWRRisk(1.5)).toBe('ramping')
    expect(getACWRRisk(1.51)).toBe('spike')
    expect(getACWRRisk(2.0)).toBe('spike')
  })
})
