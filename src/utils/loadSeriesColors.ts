...
export const LOAD_SERIES_COLORS: Record<LoadSeries, SeriesColor> = {
  ctl: {
    ...
    chipOn: 'bg-blue-600 border-blue-600 dark:bg-blue-500 dark:border-blue-500 text-white',
  ...
  atl: {
    ...
    chipOn: 'bg-red-600 border-red-600 dark:bg-red-500 dark:border-red-500 text-white',
