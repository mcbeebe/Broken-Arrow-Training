...
export default function RaceInfo({ race }: RaceInfoProps) {
  return (
    <div className="px-4 py-4 space-y-4">
      <h2 className="text-lg font-bold text-slate-800">Race Day: {race.name}</h2>

      <div className="bg-white rounded-xl p-3 shadow-sm border border-slate-100 space-y-2 text-sm">
      ...
      <div className="bg-white rounded-xl p-3 shadow-sm border border-slate-100">
        <h3 className="font-semibold text-sm text-slate-800 mb-2">Course Landmarks</h3>
      ...
      <div className="bg-white rounded-xl p-3 shadow-sm border border-slate-100">
        <h3 className="font-semibold text-sm text-slate-800 mb-2">Gear Checklist</h3>
      ...
      <div className="bg-white rounded-xl p-3 shadow-sm border border-slate-100">
        <h3 className="font-semibold text-sm text-slate-800 mb-2">Nutrition Strategy</h3>
        <p className="text-xs text-slate-600">{race.nutrition}</p>
      </div>

      <div className="bg-teal-50 rounded-xl p-3 border border-teal-200">
        <p className="text-xs text-teal-700">🎉 {race.loriNote}</p>
      </div>
    </div>
  )
}
