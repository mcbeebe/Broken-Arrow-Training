          ...
          <div className="mt-1.5 overflow-hidden rounded-lg border border-slate-200">
            <table className="w-full text-[10px]">
              ...
              <tbody className="divide-y divide-slate-100">
                ...
                <tr className="bg-white"><td className="px-2 py-1">E-Bike (default)</td><td className="text-right px-2 py-1 font-mono">0.30×</td><td className="px-2 py-1 text-slate-500">Pedal-assist covers most of the effort. Name ride "no/low assist" or "hard" to promote to regular Cycling 0.65× and capture grinding leg load that HR misses.</td></tr>
