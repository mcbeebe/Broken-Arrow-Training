...
SURFACE_INSTRUCTIONS = {
    ...
    "welcome_letter": (
        ...
        "understood them.\n"
        "2b. If the context includes a SEASON section with multiple races, the letter "
        "MUST be about the WHOLE season: name EVERY race with its date, say how the arc "
        "fits together (build \u2192 race \u2192 recover \u2192 bridge \u2192 next), call out any "
        "layered preparation, and tie it to their long-term goal. Never write as if the "
        "first race is the only goal \u2014 an athlete who listed four races must see all "
        "four acknowledged.\n"
        ...
        "3b. If the context includes a MENOPAUSE NOTE, acknowledge the midlife transition "
        "warmly and briefly — that the 'rules change' and their plan leans into strength, "
        "bone-loading, protein, and smart recovery to match. One or two supportive, "
        "non-clinical sentences; never medicalize, diagnose, or give HRT advice.\n"
